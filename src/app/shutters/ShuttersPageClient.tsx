...
const ShuttersPageClient = () => {
  ...
  const shuttersCategories = [
    ...
    },
    {
      ...
      description:
        "Premium timber shutters with furniture-quality finish. Available in multiple timber species for the ultimate luxury window treatment.",
      image: "/images/timber-shutter-1.webp",
      href: "/shutters/timber-shutters",
      features: ["Premium Timber", "Multiple Species", "Furniture Quality"],
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          <div className="text-center">
            ...
            >
              ...
              waterproof ABS shutters to luxury timber plantation shutters, we
        ...
        <div className="max-w-7xl mx-auto px-4">
          <motion.div className="text-center mb-16" variants={fadeInUp}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From waterproof ABS shutters for bathrooms to premium timber
...
export default ShuttersPageClient;
