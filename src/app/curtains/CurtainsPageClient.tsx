...
const CurtainsPageClient = () => {
  ...
  const curtainsCategories = [
    ...
    },
    {
      ...
      description:
        "Custom-made curtains with premium fabrics and professional installation. Choose from our extensive range of colors and patterns.",
      image: "/images/custom-curtain-1.webp",
      href: "/curtains/custom-curtains",
      features: ["Premium Fabrics", "Custom Design", "Professional Install"],
    },
  ];
...
export default CurtainsPageClient;
