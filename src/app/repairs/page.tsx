...
export const metadata: Metadata = {
  ...
  description:
    "Expert repair services in Sydney for blinds, awnings and curtains. Quality Blinds offers professional blind repairs, awning repairs, curtain repairs and maintenance services across Sydney from our Randwick workshop. Fast turnaround and warranty on all repairs.",
  keywords: [
    ...
    "awning repairs randwick",
    "curtain repairs randwick",
    ...
    "electric blind repairs sydney",
    "automated blind repairs sydney",
    "roller blind repairs sydney",
    "venetian blind repairs sydney",
    "roman blind repairs sydney",
    "folding arm awning repairs sydney",
    "canopy awning repairs sydney",
    "blockout curtain repairs sydney",
    "professional repair services sydney",
    "quality repairs sydney",
    "blind cord replacement sydney",
    "awning fabric replacement sydney",
    "curtain alteration sydney",
  ],
  openGraph: {
    title:
      "Repair Services Sydney | Expert Blind, Awning & Curtain Repairs | Quality Blinds",
    description:
      "Professional repair services in Sydney. Expert blind repairs, awning repairs, curtain repairs and maintenance with fast turnaround and warranty.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Repair Services Sydney - Expert Blind, Awning & Curtain Repairs",
      },
    ],
  },
};
